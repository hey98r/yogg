  ...
  const contactLinks = [
    {
      ...
      title: "Email",
      value: "ritik2578work@gmail.com",
      href: "mailto:ritik2578work@gmail.com",
    ...
    },
    {
      ...
      href: "https://www.linkedin.com/in/ritik-kumar-jha-36624730a",
    ...
    },
    {
      ...
      title: "Resume",
      value: "Download CV",
      href: "https://drive.google.com/file/d/1eW1eWLSGnZlgy7UwQGvJ7Ozw7RwqyHRo/view?usp=drivesdk",
      gradient: "from-purple-500 to-pink-500"
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-xs mb-3 md:mb-0">
            © 2025 Ritik Kumar Jha.
          </p>
          <div className="flex space-x-4">
            <a href="https://github.com/hey98r" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-400 transition-colors duration-300 text-xs">
              GitHub
            </a>
            <a href="https://www.linkedin.com/in/ritik-kumar-jha-36624730a" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-400 transition-colors duration-300 text-xs">
              LinkedIn
            </a>
            <a href="mailto:ritik2578work@gmail.com" className="text-gray-400 hover:text-blue-400 transition-colors duration-300 text-xs">
              Email
            </a>
          </div>
        </div>
